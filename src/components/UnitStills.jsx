...
// Import your images
import im1 from "../assets/images/im-1.jpg";
import im2 from "../assets/images/im-2.jpg";
import im3 from "../assets/images/im-3.jpg";
import im4 from "../assets/images/im-4.jpg";
import im5 from "../assets/images/im-5.jpg";

import im7 from "../assets/images/im-7.jpg";
import im8 from "../assets/images/im-8.jpg";
import im9 from "../assets/images/im-9.jpg";
import im10 from "../assets/images/im-10.jpg";
import im11 from "../assets/images/im-11.jpg";
import im12 from "../assets/images/im-12.jpg";
import im13 from "../assets/images/im-13.jpg";
import im14 from "../assets/images/im-14.jpg";
import im15 from "../assets/images/im-15.jpg";
import im16 from "../assets/images/im-16.jpg";
import im17 from "../assets/images/im-17.jpg";
import im6 from "../assets/images/im-6.jpg";
  ...
  return (
    <div className="unit-stills-section">
      ...
      <section className="text-center text-white py-5">
        <h1 className="display-5 fw-semibold">Unit Stills Photography Portfolio</h1>
        ...
        <p className="fw-bold text-uppercase mt-3">
          – Kyle Bonnici, Netflix Visual Communications, The Old Guard
        </p>
      </section>
